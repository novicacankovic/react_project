namespace NovicaTimovi.Migrations
{
    ...
    public partial class intial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        BrojKompletiranihProjekata = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ImeIPrezime = c.String(nullable: false, maxLength: 60),
                        Rola = c.String(nullable: false, maxLength: 29),
        ...
        {
            DropForeignKey("dbo.Zaposlens", "TimId", "dbo.Tims");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.Zaposlens", new[] { "TimId" });
